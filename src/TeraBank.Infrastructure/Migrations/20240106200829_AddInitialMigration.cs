        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SenderTransactionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreateDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdateDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_Transactions_SenderTransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_SenderTransactionId",
                table: "Transactions",
                column: "SenderTransactionId",
                unique: true,
                filter: "[SenderTransactionId] IS NOT NULL");
